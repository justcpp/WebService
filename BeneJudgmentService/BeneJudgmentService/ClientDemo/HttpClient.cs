...
namespace ClientDemo
{
    public class HttpClient
    {
        ...
        private string userAgent = "User Agent-BeneNetCore V0.1";
        ...
        private HttpWebRequest CreateRequest()
        {
            ...
            req.KeepAlive = true;
            req.Headers.Add("content", "text/html; charset=gb2312");
            ...
            if (verb == HttpVerb.POST)
            {
                ...
                if (files.Count > 0)
                {
                    ...
                    foreach (string key in postingData.Keys)
                    {
                        ...
                        writer.Write("Content-Disposition: multipart/form-data; name=\"{0}\"{1}{1}", key, newLine);
                    ...
                    foreach (HttpUploadingFile file in files)
                    {
                        ...
                        writer.Write("--" + boundary + newLine);
                        writer.Write(
                            "Content-Disposition: multipart/form-data; name=\"{0}\"; filename=\"{1}\"{2}",
                            file.FieldName,
                            strFileName,
                            newLine
                            );
                        ...
                        writer.Write("--" + boundary +"--"+ newLine);  //末尾还有"--"
                    }
                }
                else
                {
